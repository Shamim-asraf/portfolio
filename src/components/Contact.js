        ...
        <div className='col-12 col-lg-4 ps-lg-5'>
          ...
          <div className='contactType'>
            ...
            <div className='details'>
              ...
              <p className='contactDetail'>11/8, Khilkhet, Dhaka, Bangladesh.</p>
            </div>
          </div>
          <div className='contactType'>
            <div className='contactIcon'>
            ...
            <div className='details'>
              ...
              <a target='_blank' href='mailto:shamimasraf334007@gmail.com' >
                <p className='contactDetail'>shaimasraf334007@gmail.com</p>
              </a>
            </div>
          </div>
          <div className='contactType'>
            ...
            <div className='details'>
              ...
              <p className='contactDetail'>+880 1631194055</p>
            </div>
          </div>
          <div className='contactLinks'>
            <ul className='social list-unstyled'>
              <li><a title="Visit" rel="noreferrer" target="_blank" href='https://www.facebook.com/shamim.ashraf.988' name="facebook"><i className="fa fa-facebook"></i></a></li>
              <li><a title="Visit" rel="noreferrer" target="_blank" href='https://www.linkedin.com/in/shamim-asraf-943092204' name="linkedin"><i className="fa fa-linkedin"></i></a></li>
